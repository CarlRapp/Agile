...
public:
	...
	DXStructuredBuffer(ID3D11Device* d3dDevice, int elements,
...
private:
    // Not implemented
	DXStructuredBuffer(const DXStructuredBuffer&);
	DXStructuredBuffer& operator=(const DXStructuredBuffer&);
...
template <typename T>
DXStructuredBuffer<T>::DXStructuredBuffer(ID3D11Device* d3dDevice, int elements,
...
template <typename T>
T* DXStructuredBuffer<T>::MapDiscard(ID3D11DeviceContext* d3dDeviceContext)
{
...
template <typename T>
void DXStructuredBuffer<T>::Unmap(ID3D11DeviceContext* d3dDeviceContext)
{
